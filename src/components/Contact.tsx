...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 bg-[#080618]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-5 mb-10">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">financialservices@my-crmpro.com</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "rgba(124,92,252,0.12)" }}>
                ...
                <div>
                  <p className="font-semibold text-white mb-0.5">Basé en France</p>
                  <p className="text-slate-400 text-sm">Données hébergées en Europe · RGPD compliant</p>
                </div>
              </div>
            </div>

            {/* What to expect */}
            <div className="rounded-3xl p-7 border border-white/[0.08]" style={{ background: "rgba(255,255,255,0.04)" }}>
              <h3 className="font-bold text-white mb-5">Ce que vous obtiendrez :</h3>
          ...
          <div>
            {submitted ? (
              <div className="h-full flex flex-col items-center justify-center text-center p-8 rounded-3xl border border-white/[0.08]" style={{ background: "rgba(124,92,252,0.06)" }}>
              ...
              <form onSubmit={handleSubmit} className="rounded-3xl p-8 border border-white/[0.08] space-y-5" style={{ background: "rgba(255,255,255,0.04)" }}>
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-xl px-4 py-3 text-white placeholder:text-slate-500 transition-all focus:outline-none bg-white/[0.06] border border-white/[0.12]"
                      onFocus={e => e.currentTarget.style.boxShadow = "0 0 0 3px rgba(124,92,252,0.20)"}
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      value={form.sector}
                      onChange={handleChange}
                      className="w-full rounded-xl px-4 py-3 text-white transition-all focus:outline-none bg-white/[0.06] border border-white/[0.12]"
                    >
                      <option value="" className="bg-[#080618]">Choisir...</option>
                      {sectors.map((s) => (
                        <option key={s} value={s} className="bg-[#080618]">
                          {s}
                        </option>
                      ))}
                    </select>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl px-4 py-3 text-white placeholder:text-slate-500 transition-all resize-none focus:outline-none bg-white/[0.06] border border-white/[0.12]"
                    onFocus={e => e.currentTarget.style.boxShadow = "0 0 0 3px rgba(124,92,252,0.20)"}
                    onBlur={e => e.currentTarget.style.boxShadow = "none"}
                  />
                </div>
